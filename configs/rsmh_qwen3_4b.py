"""RSMH (Residual State-Space Markov Head) training config for Qwen3-4B.

Pro-designed head: GRU-like recurrent state as RESIDUAL on frozen Markov.
Zero-init warm-start means exact Markov at step 0.
"""
import os
